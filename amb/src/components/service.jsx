...
function Service() {
    return <section className={style.serviceSection} id='services' data-aos="fade-up" data-aos-duration="1000">
        <h2>
        Your Preferred SME Accountant and Tax Advisers in Nigeria
        </h2>
        <section className={style.subSec1} data-aos="fade-up" data-aos-duration="1000">
